          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-start">
            <div className="space-y-8">
              ...
              <div className="prose prose-lg prose-blue text-gray-600 leading-relaxed">
                ...
                <p>
                  Secara historis, kantor yayasan ini berdiri di tempat yang penuh makna, dahulu tempat tinggal kakek KH.M. Nur dan nenek Mardiyah. 
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-slate-300">
                <li className="flex items-start">
                  <div className="w-8 flex-shrink-0 flex justify-center mt-0.5 mr-3">
                    <svg className="w-6 h-6 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                  </div>
                  <a href="https://maps.app.goo.gl/zcNkACNpF4wwrvDq6" target="_blank" className="hover:text-white transition-colors"><span>{identity.address}</span></a>
                </li>
                 <li className="flex items-start">
                  <div className="w-8 flex-shrink-0 flex justify-center mt-0.5 mr-3">
                    <svg className="w-5 h-5 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                  </div>
                  <a href="https://wa.me/628993700085" target="_blank" className="hover:text-white transition-colors"><span>{identity.phone}</span></a>
                </li>
                 <li className="flex items-start">
                  <div className="w-8 flex-shrink-0 flex justify-center mt-0.5 mr-3">
                  ...
                  <a href="mailto:yayasancintanuralbab@gmail.com" target="_blank" className="hover:text-white transition-colors"><span>{identity.email}</span></a>
                </li>
              </ul>
            </div>
             ...
             <div>
              ...
              <div className="space-y-4">
                 <a href="https://instagram.com/nuralbab_foundation" target="_blank" className="flex items-center space-x-3 text-slate-300 hover:text-white transition-colors group">
                    <div className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center group-hover:bg-pink-600 transition-colors">
                    ...
                    <span>@nuralbab_foundation</span>
                 </a>
                 <a href="https://www.tiktok.com/@yayasancintanuralbab" target="_blank" className="flex items-center space-x-3 text-slate-300 hover:text-white transition-colors group">
                    <div className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center group-hover:bg-black transition-colors">
                    ...
                    <span>@yayasancintanuralbab</span>
                 </a>
              </div>
            </div>
          </div>
